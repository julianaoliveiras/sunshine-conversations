...
* @alias module:sunshine-conversations-client/ApiClient
* @class
*/
var ApiClient = /*#__PURE__*/function () {
  function ApiClient() {
     ...
     * @type {String}
     * @default https://api.smooch.io
     */
    this.basePath = 'https://api.smooch.io'.replace(/\/+$/, '');
    /**
    ...
    this.defaultHeaders = {
      'User-Agent': 'OpenAPI-Generator/9.8.0/Javascript(Node.js)'
    };
    /**
  ...
  */
  ...
  _createClass(ApiClient, [{
      ...
      for (var key in params) {
        if (params.hasOwnProperty(key) && params[key] != undefined && params[key] != null) {
          ...
          if (this.isFileParam(value) || Array.isArray(value)) {
            ...
            var newKey = key + '[' + Object.keys(value)[0] + ']';
    ...
    * @param {module:sunshine-conversations-client/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:sunshine-conversations-client/ApiClient}
*/
