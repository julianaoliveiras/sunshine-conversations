...
var MessagesApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(MessagesApi, [{
    key: "deleteAllMessagesWithHttpInfo",
    value: function deleteAllMessagesWithHttpInfo(appId, conversationId) {
      ...
      return this.apiClient.callApi('/v2/apps/{appId}/conversations/{conversationId}/messages', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * Delete All Messages
     * Delete all messages of a particular conversation.
    ...
    value: function deleteAllMessages(appId, conversationId) {
      return this.deleteAllMessagesWithHttpInfo(appId, conversationId).then(function (response_and_data) {
    ...
    value: function deleteMessageWithHttpInfo(appId, conversationId, messageId) {
      var postBody = null; // verify the required parameter 'appId' is set
      ...
      var accepts = ['application/json'];
      var returnType = Object;
      return this.apiClient.callApi('/v2/apps/{appId}/conversations/{conversationId}/messages/{messageId}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * Delete Message
     * Delete a single message of a particular conversation.
    ...
    key: "deleteMessage",
    value: function deleteMessage(appId, conversationId, messageId) {
      return this.deleteMessageWithHttpInfo(appId, conversationId, messageId).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    /**
    ...
    value: function listMessagesWithHttpInfo(appId, conversationId, opts) {
      opts = opts || {};
      var postBody = null; // verify the required parameter 'appId' is set
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _MessageListResponse["default"];
      return this.apiClient.callApi('/v2/apps/{appId}/conversations/{conversationId}/messages', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * List Messages
     * List all messages for a particular conversation. This API is paginated through [cursor pagination](#section/Introduction/API-pagination-and-records-limits), in the _backwards_ direction, with the most recent (i.e. last) page of messages being returned by default. The `hasMore` flag indicates whether more messages exist in the direction you are currently paginating through. To page backwards in the history, use the `beforeCursor` or follow the `prev` link. The page size limit is fixed at 100 messages per page.  ```shell /v2/apps/:appId/conversations/:conversationId/messages?page[before]=5f32b88acf6bf25073b2be56 ``` 
    ...
    key: "listMessages",
    value: function listMessages(appId, conversationId, opts) {
      return this.listMessagesWithHttpInfo(appId, conversationId, opts).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    /**
    ...
    key: "postMessageWithHttpInfo",
    value: function postMessageWithHttpInfo(appId, conversationId, messagePost) {
      var postBody = messagePost; // verify the required parameter 'appId' is set
      ...
      var accepts = ['application/json'];
      var returnType = _MessagePostResponse["default"];
      return this.apiClient.callApi('/v2/apps/{appId}/conversations/{conversationId}/messages', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * Post Message
     * Send a message in a particular conversation.
    ...
    key: "postMessage",
    value: function postMessage(appId, conversationId, messagePost) {
      return this.postMessageWithHttpInfo(appId, conversationId, messagePost).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
  }]);
