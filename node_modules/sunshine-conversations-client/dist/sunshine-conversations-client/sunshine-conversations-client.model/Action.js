...
var _LocationRequest = _interopRequireDefault(require("./LocationRequest"));
...
var Action = /*#__PURE__*/function () {
   ...
   */
  function Action(type, text, amount, uri, payload, fallback) {
    ...
    _LocationRequest["default"].initialize(this, type, text);

    _Postback["default"].initialize(this, type, text, payload);

    _Reply["default"].initialize(this, type, text, payload);
  ...
  _createClass(Action, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _LocationRequest["default"].constructFromObject(data, obj);

        _Postback["default"].constructFromObject(data, obj);

        _Reply["default"].constructFromObject(data, obj);
...
Action.prototype['openOnReceive'] = undefined; // Implement Buy interface:
...
_Buy["default"].prototype['metadata'] = undefined; // Implement Link interface:
...
_Link["default"].prototype['extraChannelOptions'] = undefined; // Implement LocationRequest interface:
...
_LocationRequest["default"].prototype['type'] = 'locationRequest';
/**
 * The button text.
 * @member {String} text
 */

_LocationRequest["default"].prototype['text'] = undefined;
/**
 * Flat object containing custom properties. Strings, numbers and booleans  are the only supported format that can be passed to metadata. The metadata is limited to 4KB in size. 
 * @member {Object} metadata
 */

_LocationRequest["default"].prototype['metadata'] = undefined; // Implement Postback interface:
...
_Postback["default"].prototype['metadata'] = undefined; // Implement Reply interface:
...
_Reply["default"].prototype['type'] = undefined;
/**
...
_Reply["default"].prototype['text'] = undefined;
/**
 * A string payload to help you identify the action context. Used when posting the reply. You can also use metadata for more complex needs.
 * @member {String} payload
 */

_Reply["default"].prototype['payload'] = undefined;
/**
 * Flat object containing custom properties. Strings, numbers and booleans  are the only supported format that can be passed to metadata. The metadata is limited to 4KB in size. 
 * @member {Object} metadata
 */

_Reply["default"].prototype['metadata'] = undefined;
/**
 * An icon to render next to the reply option.
 * @member {String} iconUrl
 */

_Reply["default"].prototype['iconUrl'] = undefined; // Implement Webview interface:
