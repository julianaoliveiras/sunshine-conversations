 ...
 * @version 9.8.0
 */
var ReferralDetails = /*#__PURE__*/function () {
  /**
  ...
  function ReferralDetails() {
    _classCallCheck(this, ReferralDetails);
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('adId')) {
          obj['adId'] = _ApiClient["default"].convertToType(data['adId'], 'String');
        }
      }
