 ...
 * @version 9.8.0
 */
var IntegrationListResponse = /*#__PURE__*/function () {
  /**
  ...
  function IntegrationListResponse() {
    _classCallCheck(this, IntegrationListResponse);
  ...
  _createClass(IntegrationListResponse, [{
    key: "getIntegrations",
    value:
    /**
    ...
    key: "setIntegrations",
    value: function setIntegrations(integrations) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('integrations')) {
          obj['integrations'] = _ApiClient["default"].convertToType(data['integrations'], [_Integration["default"]]);
        }
...
var _default = IntegrationListResponse;
