...
var _MatchCriteriaMessagebirdAllOf = _interopRequireDefault(require("./MatchCriteriaMessagebirdAllOf"));
 ...
 * @version 9.8.0
 */
var MatchCriteriaMessagebird = /*#__PURE__*/function () {
  /**
   ...
   */
  function MatchCriteriaMessagebird(type, integrationId, phoneNumber) {
    _classCallCheck(this, MatchCriteriaMessagebird);

    _MatchCriteriaBase["default"].initialize(this, type, integrationId);

    _MatchCriteriaMessagebirdAllOf["default"].initialize(this, phoneNumber);
  ...
  _createClass(MatchCriteriaMessagebird, [{
    key: "getType",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _MatchCriteriaMessagebirdAllOf["default"].constructFromObject(data, obj);
  ...
  return MatchCriteriaMessagebird;
}();
/**
 * The channel type.
 * @member {String} type
...
MatchCriteriaMessagebird.prototype['phoneNumber'] = undefined; // Implement MatchCriteriaBase interface:
...
_MatchCriteriaBase["default"].prototype['primary'] = true; // Implement MatchCriteriaMessagebirdAllOf interface:
...
_MatchCriteriaMessagebirdAllOf["default"].prototype['type'] = 'messagebird';
/**
 * The user’s phone number. It must contain the + prefix and the country code. Examples of valid phone numbers: +1 212-555-2368, +12125552368, +1 212 555 2368. Examples of invalid phone numbers: 212 555 2368, 1 212 555 2368. 
 * @member {String} phoneNumber
 */

_MatchCriteriaMessagebirdAllOf["default"].prototype['phoneNumber'] = undefined;
var _default = MatchCriteriaMessagebird;
