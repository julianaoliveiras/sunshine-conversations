...
var _LineAllOf = _interopRequireDefault(require("./LineAllOf"));
...
var Line = /*#__PURE__*/function () {
  ...
  function Line(type) {
    ...
    _LineAllOf["default"].initialize(this);
  ...
  _createClass(Line, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _LineAllOf["default"].constructFromObject(data, obj);
...
Line.prototype['lineId'] = undefined; // Implement Integration interface:
...
_Integration["default"].prototype['displayName'] = undefined; // Implement LineAllOf interface:
...
_LineAllOf["default"].prototype['type'] = 'line';
/**
 * LINE Channel ID. Can be omitted along with `channelSecret` to integrate LINE to setup a webhook before receiving the `channelId` and `channelSecret` back from LINE.
 * @member {String} channelId
 */

_LineAllOf["default"].prototype['channelId'] = undefined;
/**
 * LINE Channel Secret. Can be omitted along with `channelId` to integrate LINE to setup a webhook before receiving the `channelId` and `channelSecret` back from LINE.
 * @member {String} channelSecret
 */

_LineAllOf["default"].prototype['channelSecret'] = undefined;
/**
 * LINE Channel Access Token.
 * @member {String} channelAccessToken
 */

_LineAllOf["default"].prototype['channelAccessToken'] = undefined;
/**
 * LINE Service Code.
 * @member {String} serviceCode
 */

_LineAllOf["default"].prototype['serviceCode'] = undefined;
/**
 * LINE Switcher Secret.
 * @member {String} switcherSecret
 */

_LineAllOf["default"].prototype['switcherSecret'] = undefined;
/**
 * URL provided by LINE in the [Developer Console](https://developers.line.biz/console/).
 * @member {String} qrCodeUrl
 */

_LineAllOf["default"].prototype['qrCodeUrl'] = undefined;
/**
 * LINE Basic ID. Is automatically set when qrCodeUrl is updated.
 * @member {String} lineId
 */

_LineAllOf["default"].prototype['lineId'] = undefined;
var _default = Line;
