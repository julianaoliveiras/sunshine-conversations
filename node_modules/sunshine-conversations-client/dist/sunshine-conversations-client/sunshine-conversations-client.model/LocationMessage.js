 ...
 * @version 9.8.0
 */
var LocationMessage = /*#__PURE__*/function () {
  /**
   ...
   */
  function LocationMessage(type, coordinates) {
  ...
  _createClass(LocationMessage, [{
    ...
    key: "initialize",
    value: function initialize(obj, type, coordinates) {
      obj['type'] = type;
