...
var _ClientUpdateEventAllOf = _interopRequireDefault(require("./ClientUpdateEventAllOf"));

var _ClientUpdateEventAllOfPayload = _interopRequireDefault(require("./ClientUpdateEventAllOfPayload"));
 ...
 * @version 9.8.0
 */
var ClientUpdateEvent = /*#__PURE__*/function () {
  /**
  ...
  function ClientUpdateEvent() {
    _classCallCheck(this, ClientUpdateEvent);

    _EventSubSchema["default"].initialize(this);

    _ClientUpdateEventAllOf["default"].initialize(this);
  ...
  _createClass(ClientUpdateEvent, [{
    key: "getId",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ClientUpdateEventAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _ClientUpdateEventAllOfPayload["default"].constructFromObject(data['payload']);
        }
      }
...
ClientUpdateEvent.prototype['payload'] = undefined; // Implement EventSubSchema interface:
...
_EventSubSchema["default"].prototype['createdAt'] = undefined; // Implement ClientUpdateEventAllOf interface:

/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/ClientUpdateEventAllOfPayload} payload
 */

_ClientUpdateEventAllOf["default"].prototype['payload'] = undefined;
var _default = ClientUpdateEvent;
