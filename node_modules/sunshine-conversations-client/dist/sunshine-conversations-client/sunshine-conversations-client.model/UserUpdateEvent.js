...
var _UserUpdateEventAllOf = _interopRequireDefault(require("./UserUpdateEventAllOf"));

var _UserUpdateEventAllOfPayload = _interopRequireDefault(require("./UserUpdateEventAllOfPayload"));
 ...
 * @version 9.8.0
 */
var UserUpdateEvent = /*#__PURE__*/function () {
  /**
  ...
  function UserUpdateEvent() {
    _classCallCheck(this, UserUpdateEvent);

    _EventSubSchema["default"].initialize(this);

    _UserUpdateEventAllOf["default"].initialize(this);
  ...
  _createClass(UserUpdateEvent, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _UserUpdateEventAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _UserUpdateEventAllOfPayload["default"].constructFromObject(data['payload']);
        }
      }
...
UserUpdateEvent.prototype['payload'] = undefined; // Implement EventSubSchema interface:
...
_EventSubSchema["default"].prototype['createdAt'] = undefined; // Implement UserUpdateEventAllOf interface:

/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/UserUpdateEventAllOfPayload} payload
 */

_UserUpdateEventAllOf["default"].prototype['payload'] = undefined;
var _default = UserUpdateEvent;
