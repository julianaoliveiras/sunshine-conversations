...
var _TwitterAllOf = _interopRequireDefault(require("./TwitterAllOf"));
...
var Twitter = /*#__PURE__*/function () {
   ...
   */
  function Twitter(type, tier, consumerKey, consumerSecret, accessTokenSecret) {
    _classCallCheck(this, Twitter);

    _Integration["default"].initialize(this, type);

    _TwitterAllOf["default"].initialize(this, tier, consumerKey, consumerSecret, accessTokenSecret);
  ...
  _createClass(Twitter, [{
    ...
    key: "initialize",
    value: function initialize(obj, type, tier, consumerKey, consumerSecret, accessTokenSecret) {
      obj['tier'] = tier;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _TwitterAllOf["default"].constructFromObject(data, obj);
...
Twitter.prototype['accessTokenSecret'] = undefined; // Implement Integration interface:
...
_Integration["default"].prototype['displayName'] = undefined; // Implement TwitterAllOf interface:
...
_TwitterAllOf["default"].prototype['type'] = 'twitter';
/**
 * Your Twitter app’s tier, sandbox, premium or enterprise.
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/TwitterAllOf.TierEnum} tier
 */

_TwitterAllOf["default"].prototype['tier'] = undefined;
/**
 * The Twitter dev environments label (required for sandbox and premium tiers).
 * @member {String} envName
 */

_TwitterAllOf["default"].prototype['envName'] = undefined;
/**
 * The consumer key for your Twitter app.
 * @member {String} consumerKey
 */

_TwitterAllOf["default"].prototype['consumerKey'] = undefined;
/**
 * The consumer key secret for your Twitter app.
 * @member {String} consumerSecret
 */

_TwitterAllOf["default"].prototype['consumerSecret'] = undefined;
/**
 * The access token key obtained from your user via oauth.
 * @member {String} accessTokenKey
 */

_TwitterAllOf["default"].prototype['accessTokenKey'] = undefined;
/**
 * The access token secret obtained from your user via oauth.
 * @member {String} accessTokenSecret
 */

_TwitterAllOf["default"].prototype['accessTokenSecret'] = undefined;
/**
