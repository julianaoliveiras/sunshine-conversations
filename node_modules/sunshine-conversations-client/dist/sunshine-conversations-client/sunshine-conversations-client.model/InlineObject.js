...
var InlineObject = /*#__PURE__*/function () {
   ...
   */
  function InlineObject(code, grantType, clientId, clientSecret) {
  ...
  _createClass(InlineObject, [{
    ...
    key: "setGrantType",
    value: function setGrantType(grantType) {
    ...
    key: "initialize",
    value: function initialize(obj, code, grantType, clientId, clientSecret) {
      obj['code'] = code;
