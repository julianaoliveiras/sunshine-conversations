 ...
 * @version 9.8.0
 */
var MessagePostResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function MessagePostResponse() {
    _classCallCheck(this, MessagePostResponse);
  ...
  _createClass(MessagePostResponse, [{
    key: "getMessages",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('messages')) {
          obj['messages'] = _ApiClient["default"].convertToType(data['messages'], [_Message["default"]]);
        }
      }
...
var _default = MessagePostResponse;
