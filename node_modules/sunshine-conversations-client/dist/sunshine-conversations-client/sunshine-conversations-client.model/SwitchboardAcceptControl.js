...
var _SwitchboardAcceptControlAllOf = _interopRequireDefault(require("./SwitchboardAcceptControlAllOf"));

var _SwitchboardAcceptControlAllOfPayload = _interopRequireDefault(require("./SwitchboardAcceptControlAllOfPayload"));
 ...
 * @version 9.8.0
 */
var SwitchboardAcceptControl = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SwitchboardAcceptControl</code>.
   * @alias module:sunshine-conversations-client/sunshine-conversations-client.model/SwitchboardAcceptControl
   * @implements module:sunshine-conversations-client/sunshine-conversations-client.model/EventSubSchema
   * @implements module:sunshine-conversations-client/sunshine-conversations-client.model/SwitchboardAcceptControlAllOf
   */
  function SwitchboardAcceptControl() {
    _classCallCheck(this, SwitchboardAcceptControl);

    _EventSubSchema["default"].initialize(this);

    _SwitchboardAcceptControlAllOf["default"].initialize(this);
  ...
  _createClass(SwitchboardAcceptControl, [{
    key: "getId",
    value:
    /**
    ...
    /**
     * Constructs a <code>SwitchboardAcceptControl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sunshine-conversations-client/sunshine-conversations-client.model/SwitchboardAcceptControl} obj Optional instance to populate.
     * @return {module:sunshine-conversations-client/sunshine-conversations-client.model/SwitchboardAcceptControl} The populated <code>SwitchboardAcceptControl</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new SwitchboardAcceptControl();

        _EventSubSchema["default"].constructFromObject(data, obj);

        _SwitchboardAcceptControlAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _SwitchboardAcceptControlAllOfPayload["default"].constructFromObject(data['payload']);
        }
      }
  ...
  return SwitchboardAcceptControl;
}();
/**
...
SwitchboardAcceptControl.prototype['payload'] = undefined; // Implement EventSubSchema interface:
...
_EventSubSchema["default"].prototype['createdAt'] = undefined; // Implement SwitchboardAcceptControlAllOf interface:

/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/SwitchboardAcceptControlAllOfPayload} payload
 */

_SwitchboardAcceptControlAllOf["default"].prototype['payload'] = undefined;
var _default = SwitchboardAcceptControl;
