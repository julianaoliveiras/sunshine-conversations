...
var _AppKey = _interopRequireDefault(require("./AppKey"));
 ...
 * @version 9.8.0
 */
var AppKeyListResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function AppKeyListResponse() {
    _classCallCheck(this, AppKeyListResponse);
  ...
  _createClass(AppKeyListResponse, [{
    key: "getKeys",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('keys')) {
          obj['keys'] = _ApiClient["default"].convertToType(data['keys'], [_AppKey["default"]]);
        }
      }
...
var _default = AppKeyListResponse;
