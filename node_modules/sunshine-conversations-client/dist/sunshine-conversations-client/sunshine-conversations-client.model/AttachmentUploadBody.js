 ...
 * @version 9.8.0
 */
var AttachmentUploadBody = /*#__PURE__*/function () {
  /**
   ...
   * @param source {File} 
   */
  function AttachmentUploadBody(source) {
    _classCallCheck(this, AttachmentUploadBody);
  ...
  _createClass(AttachmentUploadBody, [{
    key: "getSource",
    value:
    /**
         * @return {File}
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('source')) {
          obj['source'] = _ApiClient["default"].convertToType(data['source'], File);
        }
      }
...
var _default = AttachmentUploadBody;
