 ...
 * @version 9.8.0
 */
var IntegrationApiKeyListResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function IntegrationApiKeyListResponse() {
    _classCallCheck(this, IntegrationApiKeyListResponse);
  ...
  _createClass(IntegrationApiKeyListResponse, [{
    key: "getKeys",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('keys')) {
          obj['keys'] = _ApiClient["default"].convertToType(data['keys'], [_ApiKey["default"]]);
        }
      }
...
var _default = IntegrationApiKeyListResponse;
