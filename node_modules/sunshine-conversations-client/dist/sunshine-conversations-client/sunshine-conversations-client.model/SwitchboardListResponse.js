 ...
 * @version 9.8.0
 */
var SwitchboardListResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function SwitchboardListResponse() {
    _classCallCheck(this, SwitchboardListResponse);
  ...
  _createClass(SwitchboardListResponse, [{
    key: "getSwitchboards",
    value:
    /**
    ...
    key: "setSwitchboards",
    value: function setSwitchboards(switchboards) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('switchboards')) {
          obj['switchboards'] = _ApiClient["default"].convertToType(data['switchboards'], [_Switchboard["default"]]);
        }
      }
...
var _default = SwitchboardListResponse;
