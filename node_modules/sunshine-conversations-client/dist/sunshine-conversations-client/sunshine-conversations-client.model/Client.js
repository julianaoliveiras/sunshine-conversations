...
var _ClientType = _interopRequireDefault(require("./ClientType"));
...
var Client = /*#__PURE__*/function () {
  ...
  _createClass(Client, [{
    ...
    key: "setLinkedAt",
    value: function setLinkedAt(linkedAt) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('type')) {
          obj['type'] = _ClientType["default"].constructFromObject(data['type']);
        }
        ...
        if (data.hasOwnProperty('linkedAt')) {
          obj['linkedAt'] = _ApiClient["default"].convertToType(data['linkedAt'], 'String');
        }
        ...
        if (data.hasOwnProperty('raw')) {
          obj['raw'] = _ApiClient["default"].convertToType(data['raw'], Object);
        }
      }
