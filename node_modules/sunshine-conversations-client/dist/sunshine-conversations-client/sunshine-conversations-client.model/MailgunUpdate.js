...
var _MailgunUpdateAllOf = _interopRequireDefault(require("./MailgunUpdateAllOf"));
 ...
 * @version 9.8.0
 */
var MailgunUpdate = /*#__PURE__*/function () {
  /**
  ...
  _createClass(MailgunUpdate, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _MailgunUpdateAllOf["default"].constructFromObject(data, obj);
...
MailgunUpdate.prototype['fromAddress'] = undefined; // Implement IntegrationUpdateBase interface:
...
_IntegrationUpdateBase["default"].prototype['displayName'] = undefined; // Implement MailgunUpdateAllOf interface:
...
_MailgunUpdateAllOf["default"].prototype['hideUnsubscribeLink'] = undefined;
/**
 * Email address to use as the From and Reply-To address if it must be different from incomingAddress. Only use this option if the address that you supply is configured to forward emails to the incomingAddress, otherwise user replies will be lost. You must also make sure that the domain is properly configured as a mail provider so as to not be flagged as spam by the user’s email client. May be unset with null.
 * @member {String} fromAddress
 */

_MailgunUpdateAllOf["default"].prototype['fromAddress'] = undefined;
var _default = MailgunUpdate;
