 ...
 * @version 9.8.0
 */
var ConversationResponse = /*#__PURE__*/function () {
  /**
  ...
  function ConversationResponse() {
    _classCallCheck(this, ConversationResponse);
  ...
  _createClass(ConversationResponse, [{
    key: "getConversation",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('conversation')) {
          obj['conversation'] = _ApiClient["default"].convertToType(data['conversation'], _Conversation["default"]);
        }
      }
...
var _default = ConversationResponse;
