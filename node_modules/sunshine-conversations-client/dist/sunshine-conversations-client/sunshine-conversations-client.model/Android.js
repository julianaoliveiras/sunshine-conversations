...
var _AndroidAllOf = _interopRequireDefault(require("./AndroidAllOf"));
...
var Android = /*#__PURE__*/function () {
  ...
  function Android(type) {
    ...
    _AndroidAllOf["default"].initialize(this);
  ...
  _createClass(Android, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _AndroidAllOf["default"].constructFromObject(data, obj);
...
Android.prototype['canUserCreateMoreConversations'] = undefined; // Implement Integration interface:
...
_Integration["default"].prototype['displayName'] = undefined; // Implement AndroidAllOf interface:
...
_AndroidAllOf["default"].prototype['type'] = 'android';
/**
 * Your server key from the fcm console.
 * @member {String} serverKey
 */

_AndroidAllOf["default"].prototype['serverKey'] = undefined;
/**
 * Your sender id from the fcm console.
 * @member {String} senderId
 */

_AndroidAllOf["default"].prototype['senderId'] = undefined;
/**
 * Allows users to create more than one conversation on the android integration.
 * @member {Boolean} canUserCreateMoreConversations
 */

_AndroidAllOf["default"].prototype['canUserCreateMoreConversations'] = undefined;
