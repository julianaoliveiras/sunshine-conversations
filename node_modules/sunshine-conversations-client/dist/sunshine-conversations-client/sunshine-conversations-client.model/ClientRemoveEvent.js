...
var _ClientRemoveEventAllOf = _interopRequireDefault(require("./ClientRemoveEventAllOf"));

var _ClientRemoveEventAllOfPayload = _interopRequireDefault(require("./ClientRemoveEventAllOfPayload"));
 ...
 * @version 9.8.0
 */
var ClientRemoveEvent = /*#__PURE__*/function () {
  /**
  ...
  function ClientRemoveEvent() {
    _classCallCheck(this, ClientRemoveEvent);

    _EventSubSchema["default"].initialize(this);

    _ClientRemoveEventAllOf["default"].initialize(this);
  ...
  _createClass(ClientRemoveEvent, [{
    key: "getId",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ClientRemoveEventAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _ClientRemoveEventAllOfPayload["default"].constructFromObject(data['payload']);
        }
      }
...
ClientRemoveEvent.prototype['payload'] = undefined; // Implement EventSubSchema interface:
...
_EventSubSchema["default"].prototype['createdAt'] = undefined; // Implement ClientRemoveEventAllOf interface:

/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/ClientRemoveEventAllOfPayload} payload
 */

_ClientRemoveEventAllOf["default"].prototype['payload'] = undefined;
var _default = ClientRemoveEvent;
