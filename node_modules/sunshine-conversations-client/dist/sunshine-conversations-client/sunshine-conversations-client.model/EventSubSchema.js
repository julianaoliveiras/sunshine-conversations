...
/**
 * The EventSubSchema model module.
 * @module sunshine-conversations-client/sunshine-conversations-client.model/EventSubSchema
 * @version 9.8.0
 */
var EventSubSchema = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>EventSubSchema</code>.
   * @alias module:sunshine-conversations-client/sunshine-conversations-client.model/EventSubSchema
   */
  function EventSubSchema() {
    _classCallCheck(this, EventSubSchema);

    EventSubSchema.initialize(this);
  }
  /**
  ...
  _createClass(EventSubSchema, [{
    ...
    /**
     * Constructs a <code>EventSubSchema</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sunshine-conversations-client/sunshine-conversations-client.model/EventSubSchema} obj Optional instance to populate.
     * @return {module:sunshine-conversations-client/sunshine-conversations-client.model/EventSubSchema} The populated <code>EventSubSchema</code> instance.
     */
