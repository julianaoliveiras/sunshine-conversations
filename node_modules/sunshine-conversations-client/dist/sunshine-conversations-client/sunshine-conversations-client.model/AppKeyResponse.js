 ...
 * @version 9.8.0
 */
var AppKeyResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function AppKeyResponse() {
    _classCallCheck(this, AppKeyResponse);
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('key')) {
          obj['key'] = _ApiClient["default"].convertToType(data['key'], _AppKey["default"]);
        }
      }
