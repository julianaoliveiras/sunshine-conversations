...
var _MessagebirdAllOf = _interopRequireDefault(require("./MessagebirdAllOf"));
 ...
 * @version 9.8.0
 */
var Messagebird = /*#__PURE__*/function () {
  /**
   ...
   */
  function Messagebird(type, accessKey, signingKey, originator) {
    _classCallCheck(this, Messagebird);

    _Integration["default"].initialize(this, type);

    _MessagebirdAllOf["default"].initialize(this, accessKey, signingKey, originator);
  ...
  _createClass(Messagebird, [{
    ...
    key: "initialize",
    value: function initialize(obj, type, accessKey, signingKey, originator) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _MessagebirdAllOf["default"].constructFromObject(data, obj);
...
Messagebird.prototype['webhookSecret'] = undefined; // Implement Integration interface:
...
_Integration["default"].prototype['displayName'] = undefined; // Implement MessagebirdAllOf interface:
...
_MessagebirdAllOf["default"].prototype['type'] = 'messagebird';
/**
 * The public API key of your MessageBird account.
 * @member {String} accessKey
 */

_MessagebirdAllOf["default"].prototype['accessKey'] = undefined;
/**
 * The signing key of your MessageBird account. Used to validate the webhooks' origin.
 * @member {String} signingKey
 */

_MessagebirdAllOf["default"].prototype['signingKey'] = undefined;
/**
 * Sunshine Conversations will receive all messages sent to this phone number.
 * @member {String} originator
 */

_MessagebirdAllOf["default"].prototype['originator'] = undefined;
/**
 * The secret that is used to configure webhooks in MessageBird.
 * @member {String} webhookSecret
 */

_MessagebirdAllOf["default"].prototype['webhookSecret'] = undefined;
var _default = Messagebird;
