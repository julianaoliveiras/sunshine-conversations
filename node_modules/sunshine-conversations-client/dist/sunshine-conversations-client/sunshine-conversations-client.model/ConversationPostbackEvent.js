...
var _ConversationPostbackEventAllOf = _interopRequireDefault(require("./ConversationPostbackEventAllOf"));

var _ConversationPostbackEventAllOfPayload = _interopRequireDefault(require("./ConversationPostbackEventAllOfPayload"));
 ...
 * @version 9.8.0
 */
var ConversationPostbackEvent = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ConversationPostbackEvent</code>.
   * @alias module:sunshine-conversations-client/sunshine-conversations-client.model/ConversationPostbackEvent
   * @implements module:sunshine-conversations-client/sunshine-conversations-client.model/EventSubSchema
   * @implements module:sunshine-conversations-client/sunshine-conversations-client.model/ConversationPostbackEventAllOf
   */
  function ConversationPostbackEvent() {
    _classCallCheck(this, ConversationPostbackEvent);

    _EventSubSchema["default"].initialize(this);

    _ConversationPostbackEventAllOf["default"].initialize(this);

    ConversationPostbackEvent.initialize(this);
  }
  /**
  ...
  _createClass(ConversationPostbackEvent, [{
    key: "getId",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ConversationPostbackEvent();

        _EventSubSchema["default"].constructFromObject(data, obj);

        _ConversationPostbackEventAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _ConversationPostbackEventAllOfPayload["default"].constructFromObject(data['payload']);
        }
      }
  ...
  return ConversationPostbackEvent;
}();
/**
...
ConversationPostbackEvent.prototype['payload'] = undefined; // Implement EventSubSchema interface:
...
_EventSubSchema["default"].prototype['createdAt'] = undefined; // Implement ConversationPostbackEventAllOf interface:

/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/ConversationPostbackEventAllOfPayload} payload
 */

_ConversationPostbackEventAllOf["default"].prototype['payload'] = undefined;
var _default = ConversationPostbackEvent;
