...
var _ActivityAllOf = _interopRequireDefault(require("./ActivityAllOf"));

var _ActivityTypes = _interopRequireDefault(require("./ActivityTypes"));

var _AuthorWebhook = _interopRequireDefault(require("./AuthorWebhook"));
...
var Activity = /*#__PURE__*/function () {
  ...
  function Activity() {
    ...
    _ActivityAllOf["default"].initialize(this);
  ...
  _createClass(Activity, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ActivityAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('author')) {
          obj['author'] = _AuthorWebhook["default"].constructFromObject(data['author']);
        }
      }
...
Activity.prototype['author'] = undefined; // Implement ActivityTypes interface:
...
_ActivityTypes["default"].prototype['type'] = undefined; // Implement ActivityAllOf interface:
...
_ActivityAllOf["default"].prototype['source'] = undefined;
/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/AuthorWebhook} author
 */

_ActivityAllOf["default"].prototype['author'] = undefined;
/**
