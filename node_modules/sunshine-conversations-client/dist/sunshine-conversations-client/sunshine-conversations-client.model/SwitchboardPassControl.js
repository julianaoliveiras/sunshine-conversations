...
var _SwitchboardPassControlAllOf = _interopRequireDefault(require("./SwitchboardPassControlAllOf"));

var _SwitchboardPassControlAllOfPayload = _interopRequireDefault(require("./SwitchboardPassControlAllOfPayload"));
 ...
 * @version 9.8.0
 */
var SwitchboardPassControl = /*#__PURE__*/function () {
  /**
   ...
   */
  function SwitchboardPassControl() {
    _classCallCheck(this, SwitchboardPassControl);

    _EventSubSchema["default"].initialize(this);

    _SwitchboardPassControlAllOf["default"].initialize(this);
  ...
  _createClass(SwitchboardPassControl, [{
    key: "getId",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _SwitchboardPassControlAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _SwitchboardPassControlAllOfPayload["default"].constructFromObject(data['payload']);
        }
      }
...
SwitchboardPassControl.prototype['payload'] = undefined; // Implement EventSubSchema interface:
...
_EventSubSchema["default"].prototype['createdAt'] = undefined; // Implement SwitchboardPassControlAllOf interface:

/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/SwitchboardPassControlAllOfPayload} payload
 */

_SwitchboardPassControlAllOf["default"].prototype['payload'] = undefined;
var _default = SwitchboardPassControl;
