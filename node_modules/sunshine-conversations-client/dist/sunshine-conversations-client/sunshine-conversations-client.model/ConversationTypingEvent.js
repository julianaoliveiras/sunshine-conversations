...
var _ConversationTypingEventAllOf = _interopRequireDefault(require("./ConversationTypingEventAllOf"));

var _ConversationTypingEventAllOfPayload = _interopRequireDefault(require("./ConversationTypingEventAllOfPayload"));
 ...
 * @version 9.8.0
 */
var ConversationTypingEvent = /*#__PURE__*/function () {
  /**
   ...
   */
  function ConversationTypingEvent() {
    _classCallCheck(this, ConversationTypingEvent);

    _EventSubSchema["default"].initialize(this);

    _ConversationTypingEventAllOf["default"].initialize(this);
  ...
  _createClass(ConversationTypingEvent, [{
    key: "getId",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ConversationTypingEventAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _ConversationTypingEventAllOfPayload["default"].constructFromObject(data['payload']);
        }
      }
...
ConversationTypingEvent.prototype['payload'] = undefined; // Implement EventSubSchema interface:
...
_EventSubSchema["default"].prototype['createdAt'] = undefined; // Implement ConversationTypingEventAllOf interface:

/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/ConversationTypingEventAllOfPayload} payload
 */

_ConversationTypingEventAllOf["default"].prototype['payload'] = undefined;
var _default = ConversationTypingEvent;
