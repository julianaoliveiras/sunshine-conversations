 ...
 * @version 9.8.0
 */
var AppListFilter = /*#__PURE__*/function () {
  /**
  ...
  function AppListFilter() {
    _classCallCheck(this, AppListFilter);
  ...
  _createClass(AppListFilter, [{
    key: "getServiceAccountId",
    value:
    /**
    ...
    key: "setServiceAccountId",
    value: function setServiceAccountId(serviceAccountId) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('serviceAccountId')) {
          obj['serviceAccountId'] = _ApiClient["default"].convertToType(data['serviceAccountId'], 'String');
        }
      }
