 ...
 * @version 9.8.0
 */
var AppListResponse = /*#__PURE__*/function () {
  /**
  ...
  function AppListResponse() {
    _classCallCheck(this, AppListResponse);
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('apps')) {
          obj['apps'] = _ApiClient["default"].convertToType(data['apps'], [_App["default"]]);
        }
