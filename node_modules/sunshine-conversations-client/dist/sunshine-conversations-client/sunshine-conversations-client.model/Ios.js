...
var _IosAllOf = _interopRequireDefault(require("./IosAllOf"));
...
var Ios = /*#__PURE__*/function () {
  ...
  function Ios(type) {
    ...
    _IosAllOf["default"].initialize(this);
  ...
  _createClass(Ios, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _IosAllOf["default"].constructFromObject(data, obj);
...
Ios.prototype['canUserCreateMoreConversations'] = undefined; // Implement Integration interface:
...
_Integration["default"].prototype['displayName'] = undefined; // Implement IosAllOf interface:
...
_IosAllOf["default"].prototype['type'] = 'ios';
/**
 * The binary of your APN certificate base64 encoded. To base64 encode your certificate you can use this command in the terminal: `openssl base64 -in YOUR_CERTIFICATE.p12 | tr -d '\\n'` 
 * @member {String} certificate
 */

_IosAllOf["default"].prototype['certificate'] = undefined;
/**
 * The password for your APN certificate.
 * @member {String} password
 */

_IosAllOf["default"].prototype['password'] = undefined;
/**
 * The APN environment to connect to (Production, if true, or Sandbox). Defaults to value inferred from certificate if not specified.
 * @member {Boolean} production
 */

_IosAllOf["default"].prototype['production'] = undefined;
/**
 * Use the unread count of the conversation as the application badge.
 * @member {Boolean} autoUpdateBadge
 */

_IosAllOf["default"].prototype['autoUpdateBadge'] = undefined;
/**
 * Allows users to create more than one conversation on the iOS integration.
 * @member {Boolean} canUserCreateMoreConversations
 */

_IosAllOf["default"].prototype['canUserCreateMoreConversations'] = undefined;
var _default = Ios;
