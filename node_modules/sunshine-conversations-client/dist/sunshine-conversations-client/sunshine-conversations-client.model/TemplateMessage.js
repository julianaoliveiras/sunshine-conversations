 ...
 * @version 9.8.0
 */
var TemplateMessage = /*#__PURE__*/function () {
  /**
   ...
   */
  function TemplateMessage(type, template) {
  ...
  _createClass(TemplateMessage, [{
    ...
    key: "initialize",
    value: function initialize(obj, type, template) {
      obj['type'] = type;
