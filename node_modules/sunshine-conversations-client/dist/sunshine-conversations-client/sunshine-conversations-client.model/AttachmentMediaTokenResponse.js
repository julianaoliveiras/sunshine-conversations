 ...
 * @version 9.8.0
 */
var AttachmentMediaTokenResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function AttachmentMediaTokenResponse() {
    _classCallCheck(this, AttachmentMediaTokenResponse);
  ...
  _createClass(AttachmentMediaTokenResponse, [{
    key: "getTokens",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('tokens')) {
          obj['tokens'] = _ApiClient["default"].convertToType(data['tokens'], {
            'String': 'String'
          });
        }
      }
...
var _default = AttachmentMediaTokenResponse;
