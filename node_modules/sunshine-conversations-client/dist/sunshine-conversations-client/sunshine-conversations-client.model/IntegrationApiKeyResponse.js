 ...
 * @version 9.8.0
 */
var IntegrationApiKeyResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function IntegrationApiKeyResponse() {
    _classCallCheck(this, IntegrationApiKeyResponse);
  ...
  _createClass(IntegrationApiKeyResponse, [{
    key: "getKey",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('key')) {
          obj['key'] = _ApiKey["default"].constructFromObject(data['key']);
        }
      }
...
var _default = IntegrationApiKeyResponse;
