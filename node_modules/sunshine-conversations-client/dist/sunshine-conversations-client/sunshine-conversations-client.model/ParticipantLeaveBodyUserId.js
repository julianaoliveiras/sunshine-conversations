 ...
 * @version 9.8.0
 */
var ParticipantLeaveBodyUserId = /*#__PURE__*/function () {
  /**
   ...
   */
  function ParticipantLeaveBodyUserId() {
    _classCallCheck(this, ParticipantLeaveBodyUserId);
  ...
  _createClass(ParticipantLeaveBodyUserId, [{
    key: "getUserId",
    value:
    /**
  ...
  return ParticipantLeaveBodyUserId;
}();
/**
...
var _default = ParticipantLeaveBodyUserId;
