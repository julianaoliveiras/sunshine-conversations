...
var _WhatsappAllOf = _interopRequireDefault(require("./WhatsappAllOf"));
...
var Whatsapp = /*#__PURE__*/function () {
   ...
   */
  function Whatsapp(type, deploymentId) {
    _classCallCheck(this, Whatsapp);

    _Integration["default"].initialize(this, type);

    _WhatsappAllOf["default"].initialize(this, deploymentId);
  ...
  _createClass(Whatsapp, [{
    ...
    key: "getDeploymentId",
    value: function getDeploymentId() {
    ...
    key: "setDeploymentId",
    value: function setDeploymentId(deploymentId) {
    ...
    key: "initialize",
    value: function initialize(obj, type, deploymentId) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _WhatsappAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('deploymentId')) {
          obj['deploymentId'] = _ApiClient["default"].convertToType(data['deploymentId'], 'String');
        }
...
Whatsapp.prototype['phoneNumber'] = undefined; // Implement Integration interface:
...
_Integration["default"].prototype['displayName'] = undefined; // Implement WhatsappAllOf interface:
...
_WhatsappAllOf["default"].prototype['type'] = 'whatsapp';
/**
 * The Id of the deployment. The integrationId and the appId will be added to the deployment. Additionally, the deployment’s status will be set to integrated.
 * @member {String} deploymentId
 */

_WhatsappAllOf["default"].prototype['deploymentId'] = undefined;
/**
 * Specify a fallback language to use when sending WhatsApp message template using the short hand syntax. Defaults to en_US. See WhatsApp documentation for more info.
 * @member {String} hsmFallbackLanguage
 * @default 'en_US'
...
_WhatsappAllOf["default"].prototype['hsmFallbackLanguage'] = 'en_US';
/**
 * The business ID associated with the WhatsApp account. In combination with accountManagementAccessToken, it’s used for Message Template Reconstruction.
 * @member {String} accountId
 */

_WhatsappAllOf["default"].prototype['accountId'] = undefined;
/**
 * An access token associated with the accountId used to query the WhatsApp Account Management API. In combination with accountId, it’s used for Message Template Reconstruction.
 * @member {String} accountManagementAccessToken
 */

_WhatsappAllOf["default"].prototype['accountManagementAccessToken'] = undefined;
/**
 * The phone number that is associated with the deployment of this integration, if one exists.
 * @member {String} phoneNumber
 */

_WhatsappAllOf["default"].prototype['phoneNumber'] = undefined;
