...
var _MatchCriteria = _interopRequireDefault(require("./MatchCriteria"));
 ...
 * @version 9.8.0
 */
var ClientCreate = /*#__PURE__*/function () {
  /**
   ...
   */
  function ClientCreate(matchCriteria, confirmation, target) {
  ...
  _createClass(ClientCreate, [{
    ...
    key: "setMatchCriteria",
    value: function setMatchCriteria(matchCriteria) {
    ...
    key: "getConfirmation",
    value: function getConfirmation() {
    ...
    key: "setConfirmation",
    value: function setConfirmation(confirmation) {
    ...
    key: "initialize",
    value: function initialize(obj, matchCriteria, confirmation, target) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('matchCriteria')) {
          obj['matchCriteria'] = _MatchCriteria["default"].constructFromObject(data['matchCriteria']);
        }

        if (data.hasOwnProperty('confirmation')) {
          obj['confirmation'] = _Confirmation["default"].constructFromObject(data['confirmation']);
        }

        if (data.hasOwnProperty('target')) {
          obj['target'] = _Target["default"].constructFromObject(data['target']);
        }
      }
