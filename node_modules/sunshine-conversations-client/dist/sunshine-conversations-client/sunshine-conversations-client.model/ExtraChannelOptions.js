...
var _ExtraChannelOptionsMessenger = _interopRequireDefault(require("./ExtraChannelOptionsMessenger"));
 ...
 * @version 9.8.0
 */
var ExtraChannelOptions = /*#__PURE__*/function () {
  /**
   ...
   */
  function ExtraChannelOptions() {
    _classCallCheck(this, ExtraChannelOptions);
  ...
  _createClass(ExtraChannelOptions, [{
    key: "getMessenger",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('messenger')) {
          obj['messenger'] = _ExtraChannelOptionsMessenger["default"].constructFromObject(data['messenger']);
        }
      }
...
var _default = ExtraChannelOptions;
