...
var _MatchCriteriaBase = _interopRequireDefault(require("./MatchCriteriaBase"));

var _MatchCriteriaTwilioAllOf = _interopRequireDefault(require("./MatchCriteriaTwilioAllOf"));
 ...
 * @version 9.8.0
 */
var MatchCriteriaTwilio = /*#__PURE__*/function () {
  /**
   ...
   */
  function MatchCriteriaTwilio(type, integrationId, phoneNumber) {
    _classCallCheck(this, MatchCriteriaTwilio);

    _MatchCriteriaBase["default"].initialize(this, type, integrationId);

    _MatchCriteriaTwilioAllOf["default"].initialize(this, phoneNumber);

    MatchCriteriaTwilio.initialize(this, type, integrationId, phoneNumber);
  }
  /**
  ...
  _createClass(MatchCriteriaTwilio, [{
    key: "getType",
    value:
    /**
    ...
    key: "initialize",
    value: function initialize(obj, type, integrationId, phoneNumber) {
      obj['type'] = type;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new MatchCriteriaTwilio();

        _MatchCriteriaBase["default"].constructFromObject(data, obj);

        _MatchCriteriaTwilioAllOf["default"].constructFromObject(data, obj);
...
MatchCriteriaTwilio.prototype['phoneNumber'] = undefined; // Implement MatchCriteriaBase interface:
...
_MatchCriteriaBase["default"].prototype['type'] = undefined;
/**
 * The ID of the integration to link. Must match the provided type.
 * @member {String} integrationId
 */

_MatchCriteriaBase["default"].prototype['integrationId'] = undefined;
/**
 * Flag indicating whether the client will become the primary for the target conversation once linking is complete.
 * @member {Boolean} primary
 * @default true
...
_MatchCriteriaBase["default"].prototype['primary'] = true; // Implement MatchCriteriaTwilioAllOf interface:
...
_MatchCriteriaTwilioAllOf["default"].prototype['type'] = 'twilio';
/**
 * The user’s phone number. It must contain the + prefix and the country code. Examples of valid phone numbers: +1 212-555-2368, +12125552368, +1 212 555 2368. Examples of invalid phone numbers: 212 555 2368, 1 212 555 2368. 
 * @member {String} phoneNumber
 */

_MatchCriteriaTwilioAllOf["default"].prototype['phoneNumber'] = undefined;
var _default = MatchCriteriaTwilio;
