...
var _ConversationMessageEventAllOf = _interopRequireDefault(require("./ConversationMessageEventAllOf"));

var _ConversationMessageEventAllOfPayload = _interopRequireDefault(require("./ConversationMessageEventAllOfPayload"));
 ...
 * @version 9.8.0
 */
var ConversationMessageEvent = /*#__PURE__*/function () {
  /**
  ...
  function ConversationMessageEvent() {
    _classCallCheck(this, ConversationMessageEvent);

    _EventSubSchema["default"].initialize(this);

    _ConversationMessageEventAllOf["default"].initialize(this);
  ...
  _createClass(ConversationMessageEvent, [{
    key: "getId",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ConversationMessageEventAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _ConversationMessageEventAllOfPayload["default"].constructFromObject(data['payload']);
        }
      }
...
ConversationMessageEvent.prototype['payload'] = undefined; // Implement EventSubSchema interface:
...
_EventSubSchema["default"].prototype['createdAt'] = undefined; // Implement ConversationMessageEventAllOf interface:

/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/ConversationMessageEventAllOfPayload} payload
 */

_ConversationMessageEventAllOf["default"].prototype['payload'] = undefined;
var _default = ConversationMessageEvent;
