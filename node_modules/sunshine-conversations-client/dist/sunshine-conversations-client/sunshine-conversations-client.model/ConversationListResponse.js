 ...
 * @version 9.8.0
 */
var ConversationListResponse = /*#__PURE__*/function () {
  /**
  ...
  function ConversationListResponse() {
    _classCallCheck(this, ConversationListResponse);
  ...
  _createClass(ConversationListResponse, [{
    ...
    value: function setConversations(conversations) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('conversations')) {
          obj['conversations'] = _ApiClient["default"].convertToType(data['conversations'], [_Conversation["default"]]);
        }
...
var _default = ConversationListResponse;
