...
var _AndroidUpdateAllOf = _interopRequireDefault(require("./AndroidUpdateAllOf"));
 ...
 * @version 9.8.0
 */
var AndroidUpdate = /*#__PURE__*/function () {
  /**
  ...
  function AndroidUpdate() {
    _classCallCheck(this, AndroidUpdate);

    _IntegrationUpdateBase["default"].initialize(this);

    _AndroidUpdateAllOf["default"].initialize(this);
  ...
  _createClass(AndroidUpdate, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _AndroidUpdateAllOf["default"].constructFromObject(data, obj);
...
AndroidUpdate.prototype['canUserCreateMoreConversations'] = undefined; // Implement IntegrationUpdateBase interface:
...
_IntegrationUpdateBase["default"].prototype['displayName'] = undefined; // Implement AndroidUpdateAllOf interface:
...
_AndroidUpdateAllOf["default"].prototype['serverKey'] = undefined;
/**
 * Your sender id from the fcm console.
 * @member {String} senderId
 */

_AndroidUpdateAllOf["default"].prototype['senderId'] = undefined;
/**
 * Allows users to create more than one conversation on the android integration.
 * @member {Boolean} canUserCreateMoreConversations
 */

_AndroidUpdateAllOf["default"].prototype['canUserCreateMoreConversations'] = undefined;
var _default = AndroidUpdate;
