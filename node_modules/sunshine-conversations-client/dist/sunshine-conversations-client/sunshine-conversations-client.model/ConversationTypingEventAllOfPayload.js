 ...
 * @version 9.8.0
 */
var ConversationTypingEventAllOfPayload = /*#__PURE__*/function () {
  /**
   ...
   */
  function ConversationTypingEventAllOfPayload() {
    _classCallCheck(this, ConversationTypingEventAllOfPayload);
  ...
  _createClass(ConversationTypingEventAllOfPayload, [{
    key: "getConversation",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('activity')) {
          obj['activity'] = _ApiClient["default"].convertToType(data['activity'], _Activity["default"]);
        }
      }
  ...
  return ConversationTypingEventAllOfPayload;
}();
/**
...
var _default = ConversationTypingEventAllOfPayload;
