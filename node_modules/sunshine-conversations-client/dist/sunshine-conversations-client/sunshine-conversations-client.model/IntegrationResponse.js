 ...
 * @version 9.8.0
 */
var IntegrationResponse = /*#__PURE__*/function () {
  /**
  ...
  function IntegrationResponse() {
    _classCallCheck(this, IntegrationResponse);
  ...
  _createClass(IntegrationResponse, [{
    key: "getIntegration",
    value:
    /**
    ...
    key: "setIntegration",
    value: function setIntegration(integration) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('integration')) {
          obj['integration'] = _Integration["default"].constructFromObject(data['integration']);
        }
      }
...
var _default = IntegrationResponse;
