...
var _CustomAllOf = _interopRequireDefault(require("./CustomAllOf"));
...
var Custom = /*#__PURE__*/function () {
   ...
   */
  function Custom(type, webhooks) {
    _classCallCheck(this, Custom);

    _Integration["default"].initialize(this, type);

    _CustomAllOf["default"].initialize(this, webhooks);
  ...
  _createClass(Custom, [{
    ...
    key: "initialize",
    value: function initialize(obj, type, webhooks) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _CustomAllOf["default"].constructFromObject(data, obj);
...
Custom.prototype['webhooks'] = undefined; // Implement Integration interface:
...
_Integration["default"].prototype['displayName'] = undefined; // Implement CustomAllOf interface:
...
_CustomAllOf["default"].prototype['type'] = 'custom';
/**
 * An array of webhooks associated with the custom integration.
 * @member {Array.<module:sunshine-conversations-client/sunshine-conversations-client.model/Webhook>} webhooks
 */

_CustomAllOf["default"].prototype['webhooks'] = undefined;
var _default = Custom;
