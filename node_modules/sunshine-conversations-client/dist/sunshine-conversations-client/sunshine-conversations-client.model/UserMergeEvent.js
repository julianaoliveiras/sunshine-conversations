...
var _UserMergeEventAllOf = _interopRequireDefault(require("./UserMergeEventAllOf"));

var _UserMergeEventAllOfPayload = _interopRequireDefault(require("./UserMergeEventAllOfPayload"));
 ...
 * @version 9.8.0
 */
var UserMergeEvent = /*#__PURE__*/function () {
  /**
   ...
   */
  function UserMergeEvent() {
    _classCallCheck(this, UserMergeEvent);

    _EventSubSchema["default"].initialize(this);

    _UserMergeEventAllOf["default"].initialize(this);
  ...
  _createClass(UserMergeEvent, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _UserMergeEventAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _UserMergeEventAllOfPayload["default"].constructFromObject(data['payload']);
        }
      }
...
UserMergeEvent.prototype['payload'] = undefined; // Implement EventSubSchema interface:
...
_EventSubSchema["default"].prototype['createdAt'] = undefined; // Implement UserMergeEventAllOf interface:

/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/UserMergeEventAllOfPayload} payload
 */

_UserMergeEventAllOf["default"].prototype['payload'] = undefined;
var _default = UserMergeEvent;
