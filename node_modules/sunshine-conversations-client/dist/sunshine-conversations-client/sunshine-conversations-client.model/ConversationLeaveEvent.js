...
var _ConversationLeaveEventAllOf = _interopRequireDefault(require("./ConversationLeaveEventAllOf"));

var _ConversationLeaveEventAllOfPayload = _interopRequireDefault(require("./ConversationLeaveEventAllOfPayload"));
 ...
 * @version 9.8.0
 */
var ConversationLeaveEvent = /*#__PURE__*/function () {
  /**
   ...
   */
  function ConversationLeaveEvent() {
    _classCallCheck(this, ConversationLeaveEvent);

    _EventSubSchema["default"].initialize(this);

    _ConversationLeaveEventAllOf["default"].initialize(this);
  ...
  _createClass(ConversationLeaveEvent, [{
    key: "getId",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ConversationLeaveEventAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _ConversationLeaveEventAllOfPayload["default"].constructFromObject(data['payload']);
        }
      }
...
ConversationLeaveEvent.prototype['payload'] = undefined; // Implement EventSubSchema interface:
...
_EventSubSchema["default"].prototype['createdAt'] = undefined; // Implement ConversationLeaveEventAllOf interface:

/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/ConversationLeaveEventAllOfPayload} payload
 */

_ConversationLeaveEventAllOf["default"].prototype['payload'] = undefined;
var _default = ConversationLeaveEvent;
