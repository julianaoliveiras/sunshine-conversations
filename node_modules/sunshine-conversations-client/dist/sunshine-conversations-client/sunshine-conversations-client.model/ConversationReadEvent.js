...
var _ConversationReadEventAllOf = _interopRequireDefault(require("./ConversationReadEventAllOf"));

var _ConversationReadEventAllOfPayload = _interopRequireDefault(require("./ConversationReadEventAllOfPayload"));
...
/**
 * The ConversationReadEvent model module.
 * @module sunshine-conversations-client/sunshine-conversations-client.model/ConversationReadEvent
 * @version 9.8.0
 */
var ConversationReadEvent = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ConversationReadEvent</code>.
   * @alias module:sunshine-conversations-client/sunshine-conversations-client.model/ConversationReadEvent
   * @implements module:sunshine-conversations-client/sunshine-conversations-client.model/EventSubSchema
   * @implements module:sunshine-conversations-client/sunshine-conversations-client.model/ConversationReadEventAllOf
   */
  function ConversationReadEvent() {
    _classCallCheck(this, ConversationReadEvent);

    _EventSubSchema["default"].initialize(this);

    _ConversationReadEventAllOf["default"].initialize(this);

    ConversationReadEvent.initialize(this);
  }
  /**
  ...
  _createClass(ConversationReadEvent, [{
    key: "getId",
    value:
    /**
    ...
    /**
     * Constructs a <code>ConversationReadEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sunshine-conversations-client/sunshine-conversations-client.model/ConversationReadEvent} obj Optional instance to populate.
     * @return {module:sunshine-conversations-client/sunshine-conversations-client.model/ConversationReadEvent} The populated <code>ConversationReadEvent</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ConversationReadEvent();

        _EventSubSchema["default"].constructFromObject(data, obj);

        _ConversationReadEventAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _ConversationReadEventAllOfPayload["default"].constructFromObject(data['payload']);
        }
      }
...
ConversationReadEvent.prototype['payload'] = undefined; // Implement EventSubSchema interface:
...
_EventSubSchema["default"].prototype['createdAt'] = undefined; // Implement ConversationReadEventAllOf interface:

/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/ConversationReadEventAllOfPayload} payload
 */

_ConversationReadEventAllOf["default"].prototype['payload'] = undefined;
var _default = ConversationReadEvent;
