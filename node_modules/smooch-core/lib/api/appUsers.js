...
Object.assign(AppUsersApi.prototype, {
     ...
     * @param {string} appUser.userId
     * @param {boolean} [appUser.credentialRequired=false]
     * @param {string} [appUser.givenName]
     * @param {string} [appUser.surname]
     * @param {string} [appUser.email]
     * @param {Date} [appUser.signedUpAt]
     * @param {object} [appUser.properties]
     * @return {APIResponse}
     */
    create: (0, _smoochMethod2.default)({
        params: ['appUser'],
        path: '/appusers',
        func: function create(url, appUser) {
            if (!appUser.userId) {
                return Promise.reject(new Error('Missing required argument: appUser.userId'));
            }

            if (appUser.signedUpAt && !(appUser.signedUpAt instanceof Date)) {
                return Promise.reject(new Error('signedUpAt must be a date.'));
            }

            // this endpoint only accepts JWT auth with app scope
            return this.request('POST', url, appUser);
        }
    }),
     ...
     * @method update
     * @param  {string} userId - a user id
     * @param  {object} appUser - the appUser props to update
     * @return {APIResponse}
     */
    update: (0, _smoochMethod2.default)({
        params: ['userId', 'appUser'],
        path: '/appusers/:userId',
        method: 'PUT'
    }),
     ...
     * @return {APIResponse}
     */
    deleteMessage: (0, _smoochMethod2.default)({
     ...
     * @return {APIResponse}
     */
    conversationActivity: (0, _smoochMethod2.default)({
     ...
     * @return {APIResponse}
     */
    getLinkRequests: (0, _smoochMethod2.default)({
     ...
     * @return {APIResponse}
     */
    mergeUsers: (0, _smoochMethod2.default)({
        params: ['props'],
        path: '/appusers/merge',
        method: 'POST'
    })
