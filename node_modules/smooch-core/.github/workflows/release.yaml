    ...
    release:
        ...
        steps:
            ...
            - name: Set GitHub information
              run: |
                git config --global user.email "ops+smooch-ci-core-js@smooch.io"
                git config --global user.name "Smooch Core JS CI"

            - name: Build the code
              run: npm run build

            - name: Release the new version
              run: python3 tasks/release.py
