...
['app', 'account'].forEach((scope) => {
    describe(`Integrations API when using ${scope} auth scope`, () => {
        ...
        describe('#create', () => {
            ...
            describe('line', () => {
                it('should not throw if no params are included', () => {
                    const props = {
                        type: 'line',
                    };
                    expect(() => api.create(appId, props)).not.to.throw();
                });
